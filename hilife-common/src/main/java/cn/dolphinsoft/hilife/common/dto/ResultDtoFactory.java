...
import cn.dolphinsoft.hilife.common.exception.BaseException;
import cn.dolphinsoft.hilife.common.exception.DisplayableError;
...
public final class ResultDtoFactory {
    ...
    private static ResultDto<String> toCommonError(String code, String msg, String details) {
        ...
        if (StringUtils.isBlank(msg)) {
            text.append(MessageUtil.getMessage(EErrorCode.COMM_INTERNAL_ERROR.getDisplayMsg())).append("[").append("时间：").append((new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")).format(new Date())).append("]");
        } else {
            text.append(msg);
        }
