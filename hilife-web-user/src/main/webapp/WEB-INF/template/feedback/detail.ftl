...
<link rel="stylesheet" type="text/css" href="${contextPath}/assets/css/page/feedback/detail.css"/>
...
<script src="${contextPath}/assets/js/1.0/page/feedback/detail.js" type="text/javascript"></script>
</html>