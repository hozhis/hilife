...
<link rel="stylesheet" type="text/css" href="${contextPath}/assets/css/page/notice/index.css"/>
...
<body>
	<div class="main-wrapper">
		<div class="header">
			...
			<div class="right"></div>
			<div class="title"><label>消息</label></div>
		</div>
		<div class="content">
...
<script src="${contextPath}/assets/js/1.0/page/notice/index.js" type="text/javascript"></script>
</html>