...
<link rel="stylesheet" type="text/css" href="${contextPath}/assets/css/page/order/evaluate.css"/>
...
<div class="main-wrapper">
	<div class="header">
		...
		<div class="right"></div>
		<div class="title"><label>发表评价</label></div>
	</div>
	<div class="content"></div>
</div>
</body>
<script src="${contextPath}/assets/js/1.0/page/order/evaluate.js" type="text/javascript"></script>
</html>